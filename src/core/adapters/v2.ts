 ...
 * side, but the two are the same point by construction — the reserved token
 ...
 * the reserves, the fee balances and the graduation state on one block — a
 ...
 * decimals are read rather than assumed — it is the one approved pair token
