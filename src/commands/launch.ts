 ...
 * relaunching the identical token collide, and that collision is a useful
...
function render(payload: LaunchPreviewPayload, paint: Painter): string {
  ...
  return [
    ...
    '',
    paint('grey', `  economics pinned to ${payload.expectedEconomics.slice(0, 18)}… and the launch reverts if the`),
