...
export const addresses = {
  ...
  /** `PonsLaunchLocker` — holds every V1 launch's V3 position and fee routing. */
  v1Locker: '0x736d76699c26d0d966744cae304c000d471f7f35',
  /** `PonsV2LaunchFactory` — V2, bonding curve graduating to Uniswap V4. */
  ...
  /**
   * `PonsV2LaunchDeployer` — CREATE2-deploys the curve/token pair. Its
